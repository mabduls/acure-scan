              ...
              <main class="flex-1 py-8 px-4">
                <div class="max-w-6xl mx-auto">
                  ...
                  <div class="mt-8 text-center">
                    <a href="#/dashboard" class="inline-block bg-gradient-to-r from-teal-500 to-cyan-400 text-white px-8 py-3 rounded-full hover:from-teal-600 hover:to-cyan-500 transition-all shadow-md hover:shadow-lg transform hover:scale-105">
