        ...
        <div class="min-h-screen bg-gradient-to-b from-[#FFECDF] to-[#C5E7E1] flex flex-col">
          ...
          <header class="bg-[#00667A] text-white py-4 px-6 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
              <button id="back-button" class="flex items-center space-x-2 hover:bg-[#004b5d] px-3 py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[#009CA6]">
              ...
              <div class="relative group">
                <button class="flex items-center space-x-2 hover:bg-[#004b5d] px-3 py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[#009CA6]">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <main class="flex-1 py-8 px-4">
            <div class="max-w-6xl mx-auto">
              ...
              <div class="mt-8 text-center">
                <a href="#/dashboard" class="inline-block bg-gradient-to-r from-teal-500 to-cyan-400 text-white px-8 py-3 rounded-full hover:from-teal-600 hover:to-cyan-500 transition-all shadow-md hover:shadow-lg transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#009CA6]">
